...
public:
    BusTrip(string maTuyen = "", string bienKiemSoat = "") {
        this->maTuyen = maTuyen;
        this->bienKiemSoat = bienKiemSoat;
    }
    bool operator==(const BusTrip& rhs) const {
        return this->maTuyen == rhs.maTuyen && this->bienKiemSoat == rhs.bienKiemSoat;
    }
};
class BusSystem {
private:
    FragmentLinkedList<BusTrip>* BusTrips;
public:
    BusSystem() {
        this->BusTrips = new FragmentLinkedList<BusTrip>();
    }
    ~BusSystem() {
        this->BusTrips->clear();
    }
    void insertBusTrip(const BusTrip& BusTrip);
    void insertBusTrip(string maTuyen, string bienKiemSoat);
};
int main()
{
    return 0;
